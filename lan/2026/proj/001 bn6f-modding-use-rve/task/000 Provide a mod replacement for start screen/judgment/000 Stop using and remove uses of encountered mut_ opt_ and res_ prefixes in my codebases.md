...
Spawned by: [lan/2026/proj/001 bn6f-modding-use-rve/task/000 Provide a mod replacement for start screen/task/003 Reproduce client server connection to lsp of lsp-cli](../task/003%20Reproduce%20client%20server%20connection%20to%20lsp%20of%20lsp-cli.md)

Spawned in: [^spawn-jdgmt-d447fd](../task/003%20Reproduce%20client%20server%20connection%20to%20lsp%20of%20lsp-cli.md#spawn-jdgmt-d447fd)

# Decision

OK

## Should we prefix with mut\_?
