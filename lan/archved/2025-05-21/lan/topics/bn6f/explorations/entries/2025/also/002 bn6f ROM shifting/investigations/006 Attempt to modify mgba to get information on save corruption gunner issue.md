...
Spawned by: [005 Look into shift test crash when fighting in central area 1 commit 6d547b86](005%20Look%20into%20shift%20test%20crash%20when%20fighting%20in%20central%20area%201%20commit%206d547b86.md)

Spawned in: [^spawn-invst-cd3046](005%20Look%20into%20shift%20test%20crash%20when%20fighting%20in%20central%20area%201%20commit%206d547b86.md#spawn-invst-cd3046)

# 1 Journal

2025-12-26 Wk 52 Fri - 12:53 +03:00

This investigation runs parallel to [000 Investigate mgba sav file format loading](../../000%20Exploring%20bn6f%20save%20data/investigations/000%20Investigate%20mgba%20sav%20file%20format%20loading.md) in that both need to understand how save file changes occur in the emulator. For our investigation here, we need to also understand what about the source ran into this problem. If we can get an ea, or some information about the state in the time of corruption it might help us narrow it down.
...
Spawn [004 Improve speed for ea_to_sym_filter](../tasks/004%20Improve%20speed%20for%20ea_to_sym_filter.md) ^spawn-task-30bc6f
...
Spawn [003 temp python script for diffing only changes after val=](../entries/003%20temp%20python%20script%20for%20diffing%20only%20changes%20after%20val=.md) ^spawn-entry-0e0040
...
Spawn [005 Create RAM struct dword_20364C0](../tasks/005%20Create%20RAM%20struct%20dword_20364C0.md) ^spawn-task-3838f9

2026-01-03 Wk 1 Sat - 16:20 +03:00

Spawn [007 Create RAM Struct byte_200BC50](../tasks/007%20Create%20RAM%20Struct%20byte_200BC50.md) ^spawn-task-dc2d18

2026-01-04 Wk 1 Sun - 14:22 +03:00

Spawn [008 Image sprite categories and indices for sprite_load](../tasks/008%20Image%20sprite%20categories%20and%20indices%20for%20sprite_load.md) ^spawn-task-6aabf7

2026-01-04 Wk 1 Sun - 18:34 +03:00

Spawn [009 Create RAM Struct Struct2035280](../tasks/009%20Create%20RAM%20Struct%20Struct2035280.md) ^spawn-task-a82dc9
...
Spawn [007 Investigate sound data structures and off_81CA450](007%20Investigate%20sound%20data%20structures%20and%20off_81CA450.md) ^spawn-invst-4ccb51
