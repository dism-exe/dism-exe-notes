...
Spawned in: [[006 Dump scripts via script tracing#^spawn-task-a567d6|^spawn-task-a567d6]]
...
Spawn [[000 Investigate parsing gfx anim scripts]] ^spawn-invst-b48fb7
...
Noted in [[005 Reminders noted during bn6f CentralArea Map Exploration]] about encountered undisassembled code for `byte_80990DC`: `cs_call_native_with_return_value ptr1=unk_8099165`
